...
/**
 * Generates and outputs header generated styleshets
 *
...
@media (min-width: <?php echo us_get_header_option( 'breakpoint', 'tablets' ) + 1 ?>px) {
...
<?php if ( us_get_header_option( 'elm_align' ) == 'left' ): ?>
...
@media (min-width: <?php echo us_get_header_option( 'breakpoint', 'mobiles' ) + 1 ?>px) and (max-width: <?php echo us_get_header_option( 'breakpoint', 'tablets' ) ?>px) {
...
@media (max-width: <?php echo us_get_header_option( 'breakpoint', 'mobiles' ) ?>px) {
...
/* Slided version of vertical header */
@media (max-width: <?php echo us_get_header_option( 'breakpoint', 'tablets' ) ?>px) {
