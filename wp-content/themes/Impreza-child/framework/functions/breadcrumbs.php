...
function us_breadcrumbs() {
	...
	$text['category'] = __( 'Category: %s', 'us' ); // text for a category page
	$text['search'] = __( 'Search results for &#8220;%s&#8221;', 'us' ); // text for a search results page
	$text['tag'] = __( 'Tag: %s', 'us' ); // text for a tag page
	$text['author'] = __( 'Author is %s', 'us' ); // text for an author page
	$text['404'] = __( 'Page not found', 'us' ); // text for the 404 page
